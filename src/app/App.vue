...
<template>
	...
	<div id="main">
		...
		<div id="app-header">
			<h1 id="app-title">reCAPTCHA梗图生成器<sup id="title-version" style="margin-left: 0.5em;">{{ version.replace('-', '\n') }}</sup></h1>

			<div id="view" style=""><Preview ref="previewRef" /></div>
		</div>
...
#title-version {
	...
	&.debug {
		animation: spin 2s linear infinite, rgb-color 10s linear infinite;
	}
}
